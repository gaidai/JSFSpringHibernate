...
import sgaidai.springhibernate.dao.UserRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(final String username) throws UsernameNotFoundException {
        ...
        System.out.println("username is:-" + username);
              sgaidai.springhibernate.model.User user = userRepository.findByUsername(username);
	...
	private User buildUserForAuthentication(sgaidai.springhibernate.model.User user, List<GrantedAuthority> authorities) {
